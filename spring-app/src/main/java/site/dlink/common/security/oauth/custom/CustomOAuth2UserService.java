...
import site.dlink.common.security.oauth.attribute.OAuth2Attribute;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if (findUser.isPresent()) {
            ...
            userAttribute.put("isExist", true);
            userAttribute.put("userId", findUser.get().getUserId());
        ...
        userAttribute.put("isExist", false);
        // 회원의 권한, 회원속성, 속성이름을 이용해 DefaultOAuth2User 객체를 생성해 반환한다.
        return new DefaultOAuth2User(
